...
const forecastData = (result) => {
  ...
  if (dataDay.includes("night")) {
    return {
      ...
      tomorrowDay: result.siteData.forecastGroup[0].forecast[2].period[0]["_"],
      tomorrowConditions:
      ...
      overmorrowDay: result.siteData.forecastGroup[0].forecast[4].period[0]["_"],
      ...
      fourthmorrowDay:
        result.siteData.forecastGroup[0].forecast[6].period[0]["_"],
      fourthmorrowConditions:
        result.siteData.forecastGroup[0].forecast[6].textSummary[0],
      fourthmorrowNightConditions:
        result.siteData.forecastGroup[0].forecast[7].textSummary[0],
